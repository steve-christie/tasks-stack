...
export default (props: ITaskCardProps) => {
  return (
    <Card>
          ...
          <div className={styles.cardWrapper}>
            ...
            <div className={styles.cardContent}>
              <div className={styles.cardTitleRow}>
                <Typography.Title level={5} className={styles.cardHeader}>
                  {props.task.title}
                </Typography.Title>
              </div>
              <div>
                ...
                {props.task.completedDate && (
                  <Tag color={"geekblue"}>
                    Completed:{" "}
                    {dayjs(props.task.completedDate).format("D MMM YYYY")}
                  </Tag>
                )}
              </div>
            </div>
      ...
      >
        <Form
          onFinish={() => props.handleEditWIthForm()}
          form={props.form}
          layout="vertical"
          initialValues={{
            ...props.task,
            ...
            completedDate: props.task.completedDate
              ? dayjs(props.task.completedDate)
              : undefined,
          }}
        >
