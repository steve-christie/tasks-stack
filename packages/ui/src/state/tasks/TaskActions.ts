...
export const CREATE_TASK: { [id: string]: string } =
  createRequestTypes("CREATE_TASK");
export const DELETE_TASK: { [id: string]: string } =
  createRequestTypes("DELETE_TASK");
export const GET_TASKS: { [id: string]: string } =
  createRequestTypes("GET_TASKS");
export const UPDATE_TASK: { [id: string]: string } =
  createRequestTypes("UPDATE_TASK");
